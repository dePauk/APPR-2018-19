...
Spodnji graf prikazuje uspešnost ekip v rednem delu VS uspešnost ekip v Play-Offih.
...
ggplot(data=podatki_ekipe_imensko, aes(x=podatki_ekipe_imensko$Uspesnost_redni_del, y=podatki_ekipe_imensko$Playoff_uspesnost)) + geom_jitter(size=(podatki_ekipe_imensko$Stevilo_playoffov)/1, shape=19, color="dodgerblue3") + 
  ggtitle("Korelacija uspešnosti (velikost kroga pomeni število uvrstitev v Play-offe)") + xlab("Uspešnost v rednem delu") + ylab("Uspešnost v Play-offih")
