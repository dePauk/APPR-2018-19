...
```{r graf_zda, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Število naslovov igralca tedna po zveznih državah', warning = FALSE}
print(graf_zda)
...
```{r graf_korelacija_uspesn, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Uspešnost ekip v rednem delu VS uspešnost ekip v Play-Offih', warning = FALSE}
